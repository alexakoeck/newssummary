...
tools1=[
    ...
    Tool(
        ...
        description='input needs : websites, query, prompt_lang and bucket_name. this tool is for article retrival and lets you search for previous responses matching the prompt and new articles from predefined websites.'
),
    Tool(
